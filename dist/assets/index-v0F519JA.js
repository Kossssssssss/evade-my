...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function gc(){return new Fn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:lo(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function _c(){return new Fn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:lo(),fragmentShader:`
...
`].filter(Yi).join(`
`)),a=Ba(a),a=Rc(a,t),a=Cc(a,t),o=Ba(o),o=Rc(o,t),o=Cc(o,t),a=Ic(a),o=Ic(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`)+`
`+f);const T=b+m+a,y=b+f+o,w=bc(i,i.VERTEX_SHADER,T),I=bc(i,i.FRAGMENT_SHADER,y);i.attachShader(_,w),i.attachShader(_,I),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function R(A){if(r.debug.checkShaderErrors){const z=i.getProgramInfoLog(_)||"",k=i.getShaderInfoLog(w)||"",G=i.getShaderInfoLog(I)||"",K=z.trim(),q=k.trim(),j=G.trim();let H=!0,re=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(H=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,w,I);else{const he=wc(i,w,"vertex"),Me=wc(i,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
